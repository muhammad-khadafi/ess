...
public class ValidatorWebUtil {
    ...
    public void validateNotDuplicate(String field, Errors errors, Object target) {
        ...
        } else if (target instanceof OrganizationCmd){
            OrganizationCmd organizationCmd = (OrganizationCmd) target;
            if (organizationService.hasDuplicateOrganizationByOrganizationCmd(organizationCmd)) {
                errors.rejectValue(field, "msg.validate.duplicate");
            }
        }
    }

    public void validateHasParent(String field, Errors errors, Object target) {
        if (target instanceof OrganizationCmd){
            OrganizationCmd organizationCmd = (OrganizationCmd) target;
            if (organizationService.hasNotParentIdByOrganizationCmd(organizationCmd)) {
                errors.rejectValue(field, "msg.validate.has.not.parent");
            }
        }
    }
