  ...
  <div @close="close">
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <p style="font-size:16px">Are you sure want to delete level rate name <strong>{{detail.levelName}}</strong>?</p>
      </section>
...
export default {
  ...
  methods: {
    fetchData () {
      ...
      let thisVM = this
      axios.get('/level-rate/view/' + this.detail.id)
      .then(function (resp) {
    ...
    submit () {
      ...
      let req = axios.delete('/level-rate/' + this.detail.id)
