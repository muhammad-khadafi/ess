  ...
  <div @close="close">
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <p style="font-size:16px">Are you sure want to delete master reference <strong>{{detail.name}}</strong>?</p>
      </section>
...
export default {
  ...
  methods: {
    fetchData () {
      ...
      let thisVM = this
      axios.get('/master-reference/' + this.detail.id)
      .then(function (resp) {
    ...
    submit () {
      ...
      let req = axios.delete('/master-reference/' + this.detail.id)
