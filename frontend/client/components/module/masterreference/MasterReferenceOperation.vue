...
import MasterReferenceForm from './MasterReferenceForm.vue'
import MasterReferenceDelete from './MasterReferenceDelete.vue'
...
export default {
  ...
  methods: {
    ...
    onClick (action, data) {
      ...
      if (action === 'edit-item') {
        this.$router.replace('/master-reference/edit/' + data.id)
      } else if (action === 'view-item') {
        this.$router.replace('/master-reference/view/' + data.id)
      } else if (action === 'delete-item') {
        this.contentComponent = 'master-reference-delete'
        this.onOpen()
      }
    }
  }
