  ...
  <div class="card-content">
      ...
      <div class="column">
          ...
          <div class="control is-horizontal">
            ...
            <div class="control is-grouped">
              <div class="control is-expanded">
                <div class="column is-half">
                  <input class="input"
                       type="text" v-model="form.category" placeholder="Category"/>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="control is-horizontal">
          ...
          <div class="control is-grouped">
            <div class="control is-expanded">
              <div class="column is-half">
                <select class="select" v-model="form.referenceType">
                  <option v-for="option in listReferenceType" :value="option.value" placeholder="- Select Refresnce Type -">
                    {{ option.text }}
                </option>
                </select>
              </div>
    ...
    <div>
      <vuetable ref="vuetable"
                api-url="/master-reference/table"
                :fields="fields"
...
import MasterReferenceOperation from './MasterReferenceOperation.vue'
import _ from 'lodash'
import bus from 'src/shared/bus'

Vue.component('masterReferenceOperation', MasterReferenceOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:master-reference-operation',
