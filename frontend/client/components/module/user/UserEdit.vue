  ...
  export default {
    ...
    methods: {
      fetchData () {
        ...
        let thisVM = this
        axios.get('/user-by-id/' + this.$route.params.id)
          .then(function (resp) {
            console.log('START FETCH')
            ...
            axios.all([
              ...
              for (let employee of employeeList.data) {
                thisVM.employeeList.push({value: employee.id, text: employee.name})
                if (thisVM.cmd.employeeId === employee.id) {
                  thisVM.employeeItem.value = employee.id
                  thisVM.employeeItem.text = employee.name
                }
              }
            }))
      ...
      validateEmployee () {
        ...
        if (this.cmd.employeeId === '' || (typeof this.cmd.employeeId === 'undefined' || this.cmd.employeeId === null)) {
          ...
          console.log('masuk employee else')
      ...
      validateUsername () {
        ...
        if (this.cmd.username === '' || (typeof this.cmd.username === 'undefined' || this.cmd.username === null)) {
          ...
          console.log('masuk username else')
      ...
      validateAll () {
        ...
        this.validateNotBlank('username', this.cmd.username)
      }
    }
  }
</script>
