<template>
  <div class="card-content">
        ...
        <div class="columns is-mobile">
          ...
          <div class="column is-half">
            <div class="control is-grouped level-left">
              <input class="input"
                     type="text" v-model="form.username" placeholder="Username"/>
            </div>
          </div>
        </div>
        <div class="columns is-mobile">
          ...
          <div class="column is-half">
            <div class="control is-grouped level-left">
              <input class="input"
                     type="text" v-model="form.employeeName" placeholder="Employee Name"/>
            </div>
          </div>
        </div>
        <div class="columns is-mobile">
          ...
          <div class="column is-half">
            <div class="control is-grouped level-left">
              <input type="checkbox" v-model="form.flagAktif" name="isActive">
            </div>
          </div>
        </div>
      </div>
      ...
      <vuetable ref="vuetable"
        ...
        <template slot="actions" scope="props">
          <div class="custom-actions">
            <button class="button is-info" @click="editUser(props.rowData)">
              <i class="fa fa-pencil"/>
            </button>
            <button class="button is-danger" @click="deleteUser(props.rowData)">
              <i class="fa fa-trash"/>
            </button>
            <br>
          </div>
    ...
    <modal :visible="showDeleteModal" @close="closeDeleteModal" transition="zoom">
      <user-delete :deleteForm="deleteCmd"  @close="closeDeleteModal"></user-delete>
    </modal>
    <div class="columns">
      <div class="column is-half is-offset-one-quarter has-text-centered">
...
<script>
  ...
  export default {
    ...
    mounted () {
      ...
      let thisVM = this
      bus.$on('RELOAD_USER_LIST', function () {
        console.log('User List RELOAD_USER_LIST', thisVM.$refs)
        console.log('User List RELOAD_USER_LIST is kosong : ', thisVM.$refs.vuetable)
    ...
    methods: {
      ...
      editUser (item) {
        this.$router.replace('/user/edit/' + item.id)
      }
    }
  }
</script>
