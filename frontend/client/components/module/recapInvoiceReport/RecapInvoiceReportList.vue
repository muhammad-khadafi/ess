<template>
  ...
  <div>
      <vuetable ref="vuetable"
                api-url="/recap-invoice-report/table"
                :fields="fields"
...
import RecapInvoiceReportOperation from './RecapInvoiceReportOperation.vue'
...
Vue.component('RecapInvoiceReportOperation', RecapInvoiceReportOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:recap-invoice-report-operation',
