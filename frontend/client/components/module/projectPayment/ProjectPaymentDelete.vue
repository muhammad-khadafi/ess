  ...
  <div @close="close">
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <p style="font-size:16px">Are you sure want to delete payment <strong>{{detail.projectContractName}}</strong>?</p>
      </section>
...
export default {
  ...
  methods: {
    fetchData () {
      ...
      let thisVM = this
      axios.get('/projectPayment/getDetail/' + this.detail.id)
      .then(function (resp) {
    ...
    submit () {
      ...
      let req = axios.delete('/projectPayment/' + this.detail.id)
