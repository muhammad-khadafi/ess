<template>
  <div class="card-content">
    ...
    <div class="columns is-mobile">
      ...
      <div class="column is-5">
        <input class="input"
               type="text" v-model="form.contractNumber" placeholder="Contract Number"/>
      </div>
    </div>
    ...
    <div class="columns is-mobile">
      ...
      <div class="column is-5">
        <input class="input"
               type="text" v-model="form.signee1" placeholder="Signee 1"/>
      </div>
    </div>
    ...
    <div class="columns is-mobile">
      ...
      <div class="column is-5">
        <input class="input"
               type="text" v-model="form.signee2" placeholder="Signee 2"/>
      </div>
    </div>
...
import ProjectContractOperation from './ProjectContractOperation.vue'
import _ from 'lodash'
import bus from 'src/shared/bus'
import axios from 'axios'
import { BasicSelect } from 'vue-search-select'

Vue.component('ProjectContractOperation', ProjectContractOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:project-contract-operation',
...
export default {
  ...
  methods: {
    ...
    addNew () {
      this.$router.replace('/projectContract/add')
    }
  }
}
</script>
