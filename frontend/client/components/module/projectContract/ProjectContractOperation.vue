...
import ProjectContractForm from './ProjectContractForm.vue'
import ProjectContractDelete from './ProjectContractDelete.vue'
...
export default {
  ...
  methods: {
    ...
    onClick (action, data) {
      ...
      if (action === 'edit-item') {
        this.$router.replace('/projectContract/edit/' + data.id)
      } else if (action === 'view-item') {
        this.$router.replace('/projectContract/view/' + data.id)
      } else if (action === 'delete-item') {
        this.contentComponent = 'project-contract-delete'
        this.onOpen()
      }
    }
  }
