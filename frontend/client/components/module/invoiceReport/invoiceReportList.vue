  ...
  <div class="box">
    ...
    <div class="columns">
      ...
      <div class="column is-6">
        <div class="control is-grouped level-left">
          <input class="input"
                 type="text" v-model="form.supervisorName" placeholder="Supervisor Name"/>
        </div>
      </div>
    </div>
...
import InvoiceReportOperation from './InvoiceReportOperation.vue'
...
Vue.component('InvoiceReportOperation', InvoiceReportOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:invoice-report-operation',
