  ...
  <div @close="close">
    <div class="modal-card">
      ...
      <section class="modal-card-body">
        <p style="font-size:16px">Are you sure want to delete <strong>{{detail.name}}</strong>?</p>
      </section>
...
export default {
  ...
  methods: {
    fetchData () {
      ...
      let thisVM = this
      axios.get('/organization-structure/' + this.detail.id)
      .then(function (resp) {
    ...
    deleteData () {
      ...
      let req = axios.delete('/organization-structure/' + this.detail.id)
