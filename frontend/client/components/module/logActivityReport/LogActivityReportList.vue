<template>
    ...
    <div class="columns">
      <div class="column is-2">
        <div class="level-right">
          <label class="label">Employee Name<font color="red">*</label>
        </div>
      </div>
  ...
  <div>
      <vuetable ref="vuetable"
                api-url="/log-activity-report/table"
                :fields="fields"
...
import LogActivityReportOperation from './LogActivityReportOperation.vue'
...
Vue.component('LogActivityReportOperation', LogActivityReportOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:log-activity-report-operation',
