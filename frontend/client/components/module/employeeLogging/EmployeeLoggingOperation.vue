...
import EmployeeLoggingForm from './EmployeeLoggingForm.vue'
import EmployeeLoggingDelete from './EmployeeLoggingDelete.vue'
import EmployeeLoggingUpdate from './EmployeeLoggingUpdate.vue'
...
export default {
  components: {
    ...
    Modal,
    EmployeeLoggingForm,
    EmployeeLoggingDelete,
    EmployeeLoggingUpdate
  },
  data () {
    return {
      visible: false,
  ...
  methods: {
    ...
    onClick (action, data) {
      ...
      if (action === 'edit-item') {
        this.contentComponent = 'employee-logging-update'
        this.onOpen()
        // this.$router.replace('/employee-logging/edit/' + data.id)
      } else if (action === 'view-item') {
        this.$router.replace('/employeePosition/view/' + data.id)
      } else if (action === 'delete-item') {
        this.contentComponent = 'employee-logging-delete'
        this.onOpen()
      }
    }
  }
