    ...
    <div class="columns">
      <div class="column">
        <vuetable ref="vuetable"
                  api-url="/employee-contract/table"
                  :fields="fields"
          ...
          <template slot="actions" scope="props">
            <div class="custom-actions">
              ...
              <button class="button is-danger" @click="deleteContract(props.rowData)">
                <i class="fa fa-trash"/>
              </button>
              <br>
            </div>
      ...
      <modal :visible="showDeleteModal" @close="closeDeleteModal" transition="zoom">
        <contract-delete :deleteForm="deleteCmd"  @close="closeDeleteModal"></contract-delete>
      </modal>
      <modal :visible="showEditModal" @close="closeEditModal" transition="zoom">
        <contract-detail-item-edit :cmd="editCmd"  @close="closeEditModal"></contract-detail-item-edit>
      </modal>
    </div>
  </div>
</template>
...
<script>
  ...
  import ContractDetailItemEdit from './ContractDetailItemEdit'
