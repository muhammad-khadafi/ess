  ...
  <div class="box">
    <div class="columns is-mobile">
      ...
      <div class="column is-5">
        <input class="input"
               type="text" v-model="form.usernameString" placeholder="Search Username"/>
      </div>
    </div>
...
import UserRoleOperation from './UserRoleOperation.vue'
import _ from 'lodash'
import bus from 'src/shared/bus'
import axios from 'axios'
import { BasicSelect } from 'vue-search-select'

Vue.component('UserRoleOperation', UserRoleOperation)
...
let tableColumns = [
  ...
  },
  {
    title: 'Action',
    titleClass: 'center aligned',
    name: '__component:user-role-operation',
...
export default {
  ...
  methods: {
    ...
    addNew () {
      this.$router.replace('/user-role/add')
    },
    deleteRole (item) {
      this.deleteCmd = item
    ...
    editRole (item) {
      this.$router.replace('/user-role/edit/' + item.id)
    }
  }
}
</script>
